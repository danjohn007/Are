...
export default function Footer() {
  ...
  const socialLinks = [
    {
      href: 'https://www.instagram.com/arerealestatemx/',
      label: 'Instagram',
      icon: (
    ...
    {
      href: 'https://www.facebook.com/alterrarealestate',
      label: 'Facebook',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="h-6 w-6">
    ...
    {
      href: 'https://www.linkedin.com/company/alterrarealestate',
      label: 'LinkedIn',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="h-6 w-6">
    ...
    {
      href: 'https://www.youtube.com/@arealterrarealestate7119',
      label: 'YouTube',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="h-6 w-6">
  ...
  return (
    <footer className="mt-12 border-t border-gray-200 bg-white/90 text-slate-600 backdrop-blur-sm">
      ...
      <div className="border-t border-gray-200 bg-isabelline/70">
        <div className="section-shell flex flex-col items-center gap-4 py-6">
