    ...
    <>
      ...
      <section className="relative overflow-hidden bg-slate-950 text-white">
        ...
        <div className="relative section-shell py-28 md:py-36">
          <div className="max-w-2xl" data-aos="fade-up">
            <span className="mb-4 inline-block rounded-full border border-brand-500 px-4 py-1.5 text-xs font-bold uppercase tracking-widest text-brand-500">
      ...
      <section className="py-20">
        <div className="section-shell">
          <div className="mb-12 text-center" data-aos="fade-up">
            <span className="text-xs font-bold uppercase tracking-widest text-brand-500">¿Por qué elegirnos?</span>
          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
            {features.map((f) => (
              <div
                key={f.title}
                data-aos="fade-up"
                className="group rounded-2xl border border-gray-100 bg-white p-8 shadow-sm transition hover:border-brand-500 hover:shadow-md"
              >
      ...
      <section className="bg-orange-50 py-20">
        <div className="section-shell grid items-center gap-10 lg:grid-cols-2">
          <div data-aos="fade-right">
            <span className="text-xs font-bold uppercase tracking-widest text-brand-500">Propiedades destacadas</span>
            <h2 className="mt-2 font-heading text-3xl font-black text-slate-950 md:text-4xl">
      ...
      <section className="bg-slate-950 py-20 text-white">
        <div className="section-shell text-center" data-aos="fade-up">
          ...
          <Link
            to="/contact"
            className="mt-8 inline-block rounded-xl bg-brand-500 px-10 py-4 font-bold text-white transition hover:bg-brand-700"
          >
            Contactar ahora
          </Link>
        </div>
